...
class StatusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status" do
    assert_difference('Status.count') do
      post status_index_url, params: { status: { descricao_status: @status.descricao_status } }
    end
  ...
  test "should update status" do
    patch status_url(@status), params: { status: { descricao_status: @status.descricao_status } }
