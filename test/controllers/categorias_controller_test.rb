...
class CategoriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post categorias_url, params: { categoria: { descricao_categoria: @categoria.descricao_categoria } }
    end
  ...
  test "should update categoria" do
    patch categoria_url(@categoria), params: { categoria: { descricao_categoria: @categoria.descricao_categoria } }
