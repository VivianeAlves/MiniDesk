...
class TecnicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tecnico" do
    assert_difference('Tecnico.count') do
      post tecnicos_url, params: { tecnico: { admin: @tecnico.admin, usuario_id: @tecnico.usuario_id } }
    end
  ...
  test "should update tecnico" do
    patch tecnico_url(@tecnico), params: { tecnico: { admin: @tecnico.admin, usuario_id: @tecnico.usuario_id } }
